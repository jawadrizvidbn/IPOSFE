...
//               <span className='text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl'>History Item Sales</span>
//             </div>
//           }
...
//         </div>
//       </div>
//       <div id='tableContainer' className='mb-5 p-5 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl'>
//         <div className='mb-5'>
//           {table &&
...
//                                     {column.id === 'totalQuantity' && formatDecimal(row.original.totalQuantity)}
//                                     {column.id === 'totalAverageCostPrice' &&
//                                       formatDecimal(row.original.totalAverageCostPrice)}
//                                     {column.id === 'totalSelling' && formatDecimal(row.original.totalSelling)}
//                                     {column.id === 'totalGpValue' && formatDecimal(row.original.totalGpValue)}
//                                   </span>
//                                 )
//                             )}
//                           </div>
...
//           #tableContainer {
//         font-size: 0.4rem; /* Adjusted for better readability */
//         width: 100%;
//         max-width: 100%;
...
//     table {
//         table-layout: fixed; /* Ensure columns fit within container */
//         width: 100%;
//         border-collapse: collapse; /* Prevent borders from causing extra space */
//     }
//          th {
//         padding: 0.1rem; /* Adjust padding as needed */
//         border: 0.1rem solid #ccc; /* Optional: add border to table cells */

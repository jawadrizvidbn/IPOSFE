...
const AllDataHistoryItemSalesRecords = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/current_invoices?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Current Invoice Sales Data Table`} />
      <div className='p-6'>
...
export default AllDataHistoryItemSalesRecords

...
const AllCreditorsCreditNotesTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/CreditorsCreditNotes_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Creditors Credit Notes Data Table`} />
      <div className='p-6'>
...
export default AllCreditorsCreditNotesTablesRecord

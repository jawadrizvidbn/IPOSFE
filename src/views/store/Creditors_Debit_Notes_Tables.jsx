...
const AllCreditorsDebitNotesTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/CreditorsDebitNotes_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Creditors Debit Notes Data Table`} />
      <div className='p-6'>
...
export default AllCreditorsDebitNotesTablesRecord

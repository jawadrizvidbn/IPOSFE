...
const AllCreditorsInvoicesTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/CreditorsInvoice_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Creditors Invoices Data Table`} />
      <div className='p-6'>
...
export default AllCreditorsInvoicesTablesRecord

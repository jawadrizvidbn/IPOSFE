...
const AllInvoicesByClerkTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/InvoicesByClerk_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} All Invoices By Clerk Data Table`} />
      <div className='p-6'>
...
export default AllInvoicesByClerkTablesRecord

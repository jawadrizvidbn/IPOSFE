...
const AllDebtorsInvoicesTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/DebtorsInvoice_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Debtors Invoices Data Table`} />
      <div className='p-6'>
...
export default AllDebtorsInvoicesTablesRecord

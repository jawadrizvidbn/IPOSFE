...
const AllDataHistoryItemSalesRecords = () => {
  ...
  const formatDate = date => {
    ...
    return `${year}${month}tbldata_adjustment`
  }
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/adjustment_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Stock Adjustments Data Table`} />
      <div className='p-6'>

...
const AllPriceChangeTablesRecord = () => {
  ...
  const formatDate = date => {
    ...
    return `${year}${month}tbldata_price`
  }
  ...
  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Price Change Data Table`} />
      <div className='p-6'>
...
export default AllPriceChangeTablesRecord

...
const AllDebtorsPaymentTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/DebtorsPayment_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Debtors Payments Data Table`} />
      <div className='p-6'>
...
export default AllDebtorsPaymentTablesRecord

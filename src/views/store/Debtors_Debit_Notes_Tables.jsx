...
const AllDebtorsDebitNotesTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/DebtorsDebitNotes_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Debtors Debit Notes Data Table`} />
      <div className='p-6'>
...
export default AllDebtorsDebitNotesTablesRecord

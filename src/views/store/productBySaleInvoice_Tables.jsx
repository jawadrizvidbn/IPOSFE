...
const ProductBySaleInvoiceTablesRecord = () => {
  ...
  const exportToReport = () => {
    ...
    window.location.href = `/en/productBySaleInvoice_Report?${queryString}`
  }

  return (
    <Card className='p-4'>
      <CardHeader title={`${shopKey.toUpperCase()} Product By Sale Invoice Data Table`} />
      <div className='p-6'>
...
export default ProductBySaleInvoiceTablesRecord

const verticalMenuData = (dictionary, params) => [
  ...
  // This is how you will normally render menu section
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            label: dictionary['navigation'].Grave,
            icon: 'ri-circle-line',
            href: '/apps/Store/Grave',
            children: [
              {
                label: dictionary['navigation'].GraveItemSale,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveItemSale'
              },
              {
                label: dictionary['navigation'].GraveItemFeb,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveItemFeb'
              },
              {
                label: dictionary['navigation'].GraveItemMarch,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveItemMarch'
              },
              {
                label: dictionary['navigation'].GraveItemApril,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveItemApril'
              },
              {
                label: dictionary['navigation'].GraveItemMay,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveItemMay'
              }
            ]
          },
          {
            label: dictionary['navigation'].Victoria,
            icon: 'ri-circle-line',
            href: '/apps/Store/Victoria',
            children: [
              {
                label: dictionary['navigation'].VictoriaItemSale,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaItemSale'
              },
              {
                label: dictionary['navigation'].VictoriaItemFeb,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaItemFeb'
              },
              {
                label: dictionary['navigation'].VictoriaItemMarch,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaItemMarch'
              },
              {
                label: dictionary['navigation'].VictoriaItemApril,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaItemApril'
              },
              {
                label: dictionary['navigation'].VictoriaItemMay,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaItemMay'
              }
            ]
          },
          {
            label: dictionary['navigation'].GraveDaily,
            icon: 'ri-circle-line',
            href: '/apps/Store/GraveDaily',
            children: [
              {
                label: dictionary['navigation'].GraveDailySale,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveDailySale'
              },
              {
                label: dictionary['navigation'].GraveDailyFeb,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveDailyFeb'
              },
              {
                label: dictionary['navigation'].GraveDailyMarch,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveDailyMarch'
              },
              {
                label: dictionary['navigation'].GraveDailyApril,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveDailyApril'
              },
              {
                label: dictionary['navigation'].GraveDailyMay,
                icon: 'ri-circle-line',
                href: '/apps/Store/GraveDailyMay'
              }
            ]
          },
          {
            label: dictionary['navigation'].VictoriaDaily,
            icon: 'ri-circle-line',
            href: '/apps/Store/VictoriaDaily',
            children: [
              {
                label: dictionary['navigation'].VictoriaDailySale,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaDailySale'
              },
              {
                label: dictionary['navigation'].VictoriaDailyFeb,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaDailyFeb'
              },
              {
                label: dictionary['navigation'].VictoriaDailyMarch,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaDailyMarch'
              },
              {
                label: dictionary['navigation'].VictoriaDailyApril,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaDailyApril'
              },
              {
                label: dictionary['navigation'].VictoriaDailyMay,
                icon: 'ri-circle-line',
                href: '/apps/Store/VictoriaDailyMay'
              }
            ]
          }
        ]
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: dictionary['navigation'].AcrossStore,
        icon: 'ri-table-alt-line',
        href: '/MultipleStore'
      },
      {

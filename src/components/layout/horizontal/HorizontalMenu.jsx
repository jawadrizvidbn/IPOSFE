        ...
        <SubMenu label={dictionary['navigation'].apps} icon={<i className='ri-mail-open-line' />}>
          ...
          <SubMenu label={dictionary['navigation'].GraveDaily} icon={<i className='ri-file-list-2-line' />}>
            ...
            <SubMenu label={dictionary['navigation'].VictoriaDaily} icon={<i className='ri-file-list-2-line' />}>
              <MenuItem href={`/${locale}/apps/Store/Victoria/VictoriaDailySale`}>
                {dictionary['navigation'].VictoriaDailySale}
              </MenuItem>
              <MenuItem href={`/${locale}/apps/Store/Victoria/VictoriaDailyFeb/${id || '4987'}`}>
                {dictionary['navigation'].VictoriaDailyFeb}
              </MenuItem>
              <MenuItem href={`/${locale}/apps/Store/Victoria/VictoriaDailyMarch/${id || '4987'}`}>
                {dictionary['navigation'].VictoriaDailyMarch}
              </MenuItem>
              <MenuItem href={`/${locale}/apps/Store/Victoria/VictoriaDailyApril`}>
                {dictionary['navigation'].VictoriaDailyApril}
              </MenuItem>
              <MenuItem href={`/${locale}/apps/Store/Victoria/VictoriaDailyMay`}>
                {dictionary['navigation'].VictoriaDailyMay}
              </MenuItem>
            </SubMenu>
          </SubMenu> */}
